    ...
    <div class="page">
        ...
        <form action="q6.php" method="post" onsubmit="return saveReport();">
            <div class="choose">
                ...
                <div class="answer">
                    <input type="radio" name="q6" id="a" value="q7.php" onclick="save()"><label for="a"><span>是</span></label><br />
                </div>
                <div class="answer">
                    <input type="radio" name="q6" id="b" value="q11.php" onclick="save()"><label for="b"><span>否</span></label><br />
                </div>
            </div>
            <div class="operBar">
